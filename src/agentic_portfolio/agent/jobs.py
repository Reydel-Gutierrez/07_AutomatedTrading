...
def catalog() -> list[JobSpec]:
    return [
        ...
        JobSpec("LIVE_ACCOUNT_REFRESH", OPEN | PRE, "interval", every_minutes=15, requires_broker=True, description="Live account/position refresh"),
        ...
        JobSpec("WEEKEND_PORTFOLIO_REVIEW", CLOSED_DAYS, "once_per_day", description="Portfolio review"),
